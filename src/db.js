...
;['anggaran','pembelian','po','realisasi','penerimaan','barang','hutang_obat','obat_belum','bpjs_prb','bpjs_alkes','pinjaman','mutasi','penjualan','arsip','tidak_datang','stok_opname'].forEach(n => {
