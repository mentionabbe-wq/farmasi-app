...
;['anggaran','pembelian','po','realisasi','penerimaan','barang','petugas','principle','hutang_obat','obat_belum','bpjs_prb','bpjs_alkes','bpjs_iterasi','pinjaman','mutasi','permintaan','penjualan','arsip','tidak_datang','stok_opname','users','sessions'].forEach(n => {
